...
public class Plats {
    ...
    private Plats() {
        ...
        Plat p2 = new Plat("fraise",15,"",new HashMap<Ingredient, Boolean>(), false);
        Plat p3 = new Plat("pate",15,"", new HashMap<Ingredient, Boolean>(), false);
        Plat p4 = new Plat("jabom",15,"", new HashMap<Ingredient, Boolean>(), false);
        Plat p5 = new Plat("tartiflette",15,"", new HashMap<Ingredient, Boolean>(), false);
        ...
        Plat p8 = new Plat("chose verte",15,"", new HashMap<Ingredient, Boolean>(), false);
        plats.add(p1);
        plats.add(p2);
        plats.add(p3);
        plats.add(p4);
